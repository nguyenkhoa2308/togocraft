...
const posts = [
  {
    ...
    excerpt: 'Khám phá câu chuyện về nghề đan lát truyền thống đã tồn tại hàng trăm năm và cách chúng tôi gìn giữ, phát triển di sản này.',
    date: '20/11/2024',
  ...
  },
  {
    ...
    excerpt: 'Hướng dẫn chi tiết cách vệ sinh và bảo quản đèn mây tre đúng cách để giữ vẻ đẹp tự nhiên theo thời gian.',
    date: '18/11/2024',
    category: 'Hướng dẫn',
    image: 'https://images.unsplash.com/photo-1513506003013-d531625a020d?w=800&auto=format&fit=crop&q=60'
  },
  {
    id: 3,
    slug: '5-y-tuong-trang-tri-phong-khach',
    title: '5 ý tưởng trang trí nhà với sản phẩm mây tre',
    excerpt: 'Biến không gian sống của bạn trở nên ấm cúng và gần gũi thiên nhiên với những món đồ thủ công mỹ nghệ.',
    date: '15/11/2024',
