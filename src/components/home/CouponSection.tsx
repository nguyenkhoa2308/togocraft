...
const coupons = [
  ...
  },
  {
    id: 2,
    code: "CRAFT100",
    description: "Giảm 100k giá trị đơn hàng",
    expiry: "24/12/2026",
    color: "bg-[#FFF7ED]",
  },
  {
    id: 3,
    code: "CRAF50",
    description: "Giảm 50k giá trị đơn hàng",
    expiry: "25/12/2026",
    color: "bg-[#FFF7ED]",
  },
  {
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {coupons.map((coupon) => (
            <div
              key={coupon.id}
              className="flex bg-[#F9FAFB] rounded-lg overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow"
            >
              {/* Left Side - Icon */}
