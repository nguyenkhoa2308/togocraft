                ...
                <div className="relative z-10 h-full flex flex-col justify-center">
                  <div className="mb-8">
                    ...
                    <p className="text-white/90 text-lg leading-relaxed">
                      Chào mừng bạn quay trở lại! Đăng nhập để khám phá những sản phẩm thủ công mỹ nghệ độc đáo và nhận nhiều ưu đãi hấp dẫn.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span>Sản phẩm thủ công 100% Việt Nam</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="text-right">
                    <Link
                      ...
                      className="text-sm text-[#C59263] hover:underline"
                    >
                      Quên mật khẩu?
                    </Link>
                  </div>
